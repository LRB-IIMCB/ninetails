...
The output plot includes an entire tail region (orange) and +/- 150
positions flanks of adapter (blue) and transcript body (black) regions.
Vertical lines mark the 5' (navy blue) and 3' (red) termini of polyA
