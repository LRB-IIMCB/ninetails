---
title: "TailfindR compatibility"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{TailfindR compatibility}
...
> **Note:** TailfindR compatibility applies only to the **Guppy legacy pipeline** (`check_tails_guppy()`).

Since version 1.0.2, **ninetails** is compatible with [tailfindR](https://github.com/adnaniazi/tailfindr).
