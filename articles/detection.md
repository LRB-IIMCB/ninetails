...
is the recommended function for direct RNA sequencing (DRS) data
...
extends the DRS pipeline for complementary DNA (cDNA) sequencing data
...
is the legacy function for DRS data basecalled with Guppy using fast5
