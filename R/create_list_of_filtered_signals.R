...
#'}
#'
create_list_of_filtered_signals <- function(tail_chunk_list, num_cores){
  ...
  output_only_filtered <- mod_list[sapply(mod_list,function(vec) any(with(rle(vec==1), lengths > 4 & values)))]
