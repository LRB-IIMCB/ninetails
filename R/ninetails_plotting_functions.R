...
plot_tail_chunk <- function(chunk_name, tail_chunk_list) {
  ...
  #plot
  p <- ggplot2::ggplot(data = signal_df, ggplot2::aes(x = position)) +
    ggplot2::geom_line(ggplot2::aes(y = signal), color="#3271a8") + ggplot2::theme_bw() + ggplot2::labs(title=paste0("Read ", chunk_name))
