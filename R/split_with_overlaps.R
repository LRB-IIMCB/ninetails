...
#' missing data (NAs) with 3 most frequent values from the entire signal
#' (randomly sampled).
#'
...
split_with_overlaps <- function(signal, segment, overlap) {
  ...
  #this is to avoid an error generated by cut() wrapped in color_matrix in gasf creator function
